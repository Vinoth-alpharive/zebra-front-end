...
<Box sx={{ flexGrow: 1 }}>
    ...
    <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
        <div className='coins-block-inner'>
            ...
            <span>${parseFloat(databtc.a)}</span>
            </div>
            <div className='coins-block-right'>
             ...
             <div className='chart-block'><img src={redgraph}/></div>
              ...
              {databtc.P > 0 ?
             <div className='rate-percentage'>+{parseFloat(databtc.P)}%</div>:
             <div className='rate-perneg'>{parseFloat(databtc.P)}%</div>
              }
            </div>
        </div>
    </Grid>
    ...
    <div className='coins-block-inner'>
            ...
            <span>${parseFloat(dataeth.a)}</span>
            </div>
            <div className='coins-block-right'>
              {dataeth.P > 0?
             <div className='chart-block'><img src={graphimg}/></div>:
             <div className='chart-block'><img src={redgraph}/></div>
              ...
              {dataeth.P > 0 ?
             <div className='rate-percentage'>+{parseFloat(dataeth.P)}%</div>:
             <div className='rate-perneg'>{parseFloat(dataeth.P)}%</div>
              }
            </div>
        </div>
    </Grid>
    ...
    <div className='coins-block-inner'>
            ...
            <span>${parseFloat(dataxrp.a)}</span>
            </div>
            <div className='coins-block-right'>
              {dataxrp.P > 0?
             <div className='chart-block'><img src={graphimg}/></div>:
             <div className='chart-block'><img src={redgraph}/></div>
              ...
              {dataxrp.P > 0 ?
             <div className='rate-percentage'>+{parseFloat(dataxrp.P)}%</div>:
             <div className='rate-perneg'>{parseFloat(dataxrp.P)}%</div>
              }
            </div>
        </div>
    </Grid>
    ...
    <div className='coins-block-inner last'>
            ...
            <span>${parseFloat(datatron.a)}</span>
            </div>
            <div className='coins-block-right'>
              {datatron.P > 0?
             <div className='chart-block'><img src={graphimg}/></div>:
             <div className='chart-block'><img src={redgraph}/></div>
              ...
              {datatron.P > 0 ?
             <div className='rate-percentage'>+{parseFloat(datatron.P)}%</div>:
             <div className='rate-perneg'>{parseFloat(datatron.P)}%</div>
              }
            </div>
        </div>
    </Grid>
